...
clc;
addpath('C:\Users\Dell\Documents\MATLAB\GA_V4');  % should point to fgeneric.m etc.
datapath = 'C:\Users\Dell\Documents\MATLAB\GA_V4\experiments\exp1';  % different folder for each experiment
% opt.inputFormat = 'row';
opt.algName = 'Sphere Function';
opt.comments = 'Multiple Dimensions, Crossover & Roulette Selection';
...
functions = [1];  % or benchmarksnoisy(...)
  ...
  for ifun = functions
    for iinstance = instances
      ...
      for restarts = 0:maxrestarts
        ...
        GA_OPTIMIZER('fgeneric', dim, fgeneric('ftarget'), ...
