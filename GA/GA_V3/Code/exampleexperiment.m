...
clc;
addpath('C:\Users\Dell\Documents\MATLAB\GA_V3');  % should point to fgeneric.m etc.
datapath = 'C:\Users\Dell\Documents\MATLAB\GA_V3\experiments\exp1';  % different folder for each experiment
% opt.inputFormat = 'row';
opt.algName = 'Sphere Function';
opt.comments = 'Multiple Dimensions & Crossover';
