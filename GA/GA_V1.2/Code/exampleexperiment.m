...
clc;
addpath('C:\Users\Dell\Documents\MATLAB\GA_V1.2');  % should point to fgeneric.m etc.
datapath = 'C:\Users\Dell\Documents\MATLAB\GA_V1.2\experiments\exp1';  % different folder for each experiment
% opt.inputFormat = 'row';
